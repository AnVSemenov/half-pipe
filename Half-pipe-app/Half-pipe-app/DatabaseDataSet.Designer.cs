...
namespace Half_pipe_app {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class BuyersDataTable : global::System.Data.TypedTableBase<BuyersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BuyersRow AddBuyersRow(string FIO, string Telephone, string Passport, string Other) {
        ...
        public partial class BuyersRow : global::System.Data.DataRow {
            ...
            public string FIO {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'FIO\' в таблице \'Buyers\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsFIONull() {
                return this.IsNull(this.tableBuyers.FIOColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetFIONull() {
                this[this.tableBuyers.FIOColumn] = global::System.Convert.DBNull;
            }
...
namespace Half_pipe_app.DatabaseDataSetTableAdapters {
    ...
    public partial class BuyersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Buyers` WHERE ((`ID` = ?) AND ((? = 1 AND `FIO` IS NULL) OR (`FIO` =" +
                " ?)) AND ((? = 1 AND `Telephone` IS NULL) OR (`Telephone` = ?)) AND ((? = 1 AND " +
                "`Passport` IS NULL) OR (`Passport` = ?)) AND ((? = 1 AND `Other` IS NULL) OR (`O" +
                "ther` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Buyers` (`FIO`, `Telephone`, `Passport`, `Other`) VALUES (?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Buyers` SET `FIO` = ?, `Telephone` = ?, `Passport` = ?, `Other` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FIO` IS NULL) OR (`FIO` = ?)) AND ((? = 1 AND `Telephone` IS NULL) OR (`Telephone` = ?)) AND ((? = 1 AND `Passport` IS NULL) OR (`Passport` = ?)) AND ((? = 1 AND `Other` IS NULL) OR (`Other` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FIO, Telephone, Passport, Other FROM Buyers";
        ...
        public virtual int Fill(DatabaseDataSet.BuyersDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.BuyersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.BuyersDataTable dataTable = new DatabaseDataSet.BuyersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.BuyersDataTable dataTable) {
        ...
        public virtual int Insert(string FIO, string Telephone, string Passport, string Other) {
            if ((FIO == null)) {
